...
cada trecho de código. Modelo fraco não erra a regra CSS, erra o loop — e cada retrabalho
...
- **Estado:** publicado e verificado.
- **Observações:** JS inteiro num bloco só no rodapé; `.js-item-product` tem id com sufixo
  aleatório, use a classe.
```
